...
public class Icon {
    ...
    public Pixel getPixelAt (int x, int y){
        ...
        if(x > x_dim || x < 0 || y > y_dim || y < 0){
            if(x > x_dim || x < 0){
                System.out.println("Cannot get pixel: X value out of bounds");
                throw new IndexOutOfBoundsException();
            }

            if(y > y_dim || y < 0){
                System.out.println("Cannot get pixel: Y value out of bounds");
                throw new IndexOutOfBoundsException();
            }
    ...
    public void setPixelAt (int x, int y, int r, int g, int b){
        ...
        if(x > x_dim || x < 0 || y > y_dim || y < 0){
            if(x > x_dim || x < 0){
                System.out.println("Error, Cannot set pixel: X value out of bounds");
                throw new IndexOutOfBoundsException();
            }

            if(y > y_dim || y < 0){
                System.out.println("Error, Cannot set pixel: Y value out of bounds");
                throw new IndexOutOfBoundsException();
            }
            ...
            if(r > 255 || r < 0 || g > 255 || g < 0 || b > 255 || b < 0){
                System.out.println("Error: Invalid RGB Value");
            }
            else {
